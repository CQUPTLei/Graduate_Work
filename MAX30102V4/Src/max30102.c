...
{ 
	...
	max30102_i2c_write(MODE_CONFIGURATION,0x40);  //重置
	
	delay_ms(5);
	
	max30102_i2c_write(INTERRUPT_ENABLE1,0xE0);
	max30102_i2c_write(INTERRUPT_ENABLE2,0x00);  //中断使能: FIFO almost full flag, new FIFO Data Ready,
																						 	
	max30102_i2c_write(FIFO_WR_POINTER,0x00);    // ambient light cancellation overflow, power ready flag, 
